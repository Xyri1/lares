...
```sh
./scripts/install-local.sh install "/absolute/path/Lares-0.1.0-alpha.3-macOS-universal-unsigned.dmg"
...
```powershell
.\scripts\install-local.ps1 install "C:\local\Lares-0.1.0-alpha.3-Windows-x64-unsigned.exe"
